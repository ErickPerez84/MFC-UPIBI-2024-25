...
public:
  ...
  void setCalibration_300mV_100uA();
  ...
  bool success();
  /*!
 *  @brief  Public function to get raw shunt voltage
 *  @return the raw shunt voltage reading
 */
int16_t getRawShuntVoltage();

/*!
 *  @brief  Public function to get raw bus voltage
 *  @return the raw bus voltage reading
 */
int16_t getRawBusVoltage();

/*!
 *  @brief  Public function to get raw current
